...
class MoleculeDatapoint:
    ...
    def __init__(self,
                 ...
                 atom_map: List[int] = None,
                 atom_xyz: List[Optional[float]] = None,
    ...
    @property
    def atommap(self) -> List[int]:
        atommap_list = self.atom_map
        return atommap_list
    
    @property
    def xyz(self) -> List[float]:
        atomxyz_list = self.atom_xyz
        return atomxyz_list
    ...
    def batch_graph(self) -> List[BatchMolGraph]:
        ...
        if self._batch_graph is None:
            ...
            for d in self._data:  # d = MoleculeDataPoint
                mol_graphs_list = []
                for s, m, xyz in zip(d.smiles, d.mol,d.atom_xyz): 
                    if s+str(xyz) in SMILES_TO_GRAPH:
                        mol_graph = SMILES_TO_GRAPH[s+str(xyz)]
                    else:
