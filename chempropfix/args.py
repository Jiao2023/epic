...
class TrainArgs(CommonArgs):
    ...
    # add
    atom_map_columns:List[str] = None
    atom_xyz_columns:List[str] = None
    ...
    """
    ignore_columns: List[str] = ["atom_map","all_xyz_coo","index","A","B","C"]
    ...
    encoder_type :Literal["gcn","gcn_attn","gcn_pe","gat","gat_attn","gat_pe","polygin", "polygin_attn","gin","gin_attn","gin_pe","polygnn_attn_adj","polygin_attn_adj"] = "polygin"
    gnn_dropout: int = 0
