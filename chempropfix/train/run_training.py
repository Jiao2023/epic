...
from chempropfix.data import get_class_sizes, get_data, MoleculeDataLoader, MoleculeDataset, set_cache_graph, split_data
...
def run_training(args: TrainArgs,
    ...
    for model_idx in range(args.ensemble_size):
        ...
        # 随机产生一个seed作为每个模型训练的随机种子
        model_seed = random.randint(0,100)
        save_dir = os.path.join(args.save_dir, f'{model_seed}')
        makedirs(save_dir)
        ...
        if empty_test_set:
            ...
            #[13389,12]当前模型预测结果和实际结果求mae和rmse
